...
class ChangeLangPost extends ModelJson{
    function __construct(){  
        parent::__construct(null, isset($_POST['state']) && $_POST['state'] === 'branch' || isset($_POST['state']) && $_POST['state'] === 'branch2'?'SuccessfullyChangeBranch':(isset($_POST['state']) && $_POST['state'] === 'AllNamesLanguage'?'ChangeLang':'ChangeStyleMessage'));
    }
    function getView(){
