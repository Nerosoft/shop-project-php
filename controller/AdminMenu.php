...
class AdminMenu extends InformationPage
{
    ...
    function __construct($idPage, $DataView, $keysTable, $keyTitle = 'AdminDashboard', $actionPost = null){
        parent::__construct($idPage, $actionPost??('ChangeLanguagePost?id='.$idPage));
